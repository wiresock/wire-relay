...
does not imply that a commercial license has been issued. Until a separate
agreement is executed, use and distribution under the open-source option are
governed by `AGPL-3.0-or-later`.

Do not send vulnerability details to the commercial licensing contact. Follow
